  ...
  return (
      ...
      <div className="mt-8 sm:mt-12 lg:mt-16 relative flex justify-center">
        <div id="Glow" className="shadow-glow w-full max-w-xs sm:max-w-sm lg:max-w-md"/>
          ...
          <input id="address" placeholder="Browse the web freely" className="w-full max-w-xs sm:max-w-sm lg:max-w-md bg-[#181818] text-base text-[rgba(235, 235, 245, 0.6)] py-3 px-4 rounded-lg outline-none mt-8 sm:mt-12 lg:mt-16 relative flex justify-center"  />
            </form>
      </div>
</>
)
